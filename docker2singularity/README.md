...
This is an inherited container build from [docker2singularity](https://www.github.com/singularityware/docker2singularity) that uses a common base installed with Singularity. See the README.md in that repository for details, and here is the quick usage.
